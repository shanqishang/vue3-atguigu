<template>
  <el-drawer v-model="isOpen" direction="rtl">
    ...
    <template #default>
      <el-form :model="userForm" label-width="100" :rules="rules" label-position="left" ref="userFormRef">
        ...
        <el-form-item label="用户密码" prop="password" v-if="props.option !== '修改'">
    ...
    <template #footer>
      <div style="flex: auto">
        ...
        <el-button type="primary" @click="confirmClick(userFormRef)">确认</el-button>
      </div>
    </template>
  </el-drawer>
</template>
