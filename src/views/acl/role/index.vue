<template>
  <div class="role">
    <el-card>
      <div class="search-box">
        <div class="left-search">
          ...
          <el-input v-model="roleName" style="width: 240px" placeholder="请输入职位搜索关键词" />
        </div>
    ...
    <el-card style="margin-top:20px;">
      <el-button type="primary" icon="Plus" @click="openRole">添加职位</el-button>
      <el-table
        border
        ref="roleRef"
        :data="tableData"
      ...
      >
        <el-table-column type="index" label="#" width="80" header-align="center" align="center"/>
        <el-table-column property="id" label="ID" width="120" header-align="center" align="center"/>
        <el-table-column property="roleName" label="职位名称" width="200" header-align="center" align="center"/>
        <el-table-column property="createTime" label="创建时间" width="200" header-align="center" align="center"/>
        <el-table-column property="updateTime" label="更新时间" width="200" header-align="center" align="center"/>
        <el-table-column label="操作" header-align="center" align="center">
          <template #default="scope">
            <el-button type="primary" icon="User" size="small" @click="assignRole(scope.row)">分配权限</el-button>
            <el-button type="primary" icon="Edit" size="small" @click="editRole(scope.row)">编辑</el-button>
            <el-popconfirm title="是否要删除这条数据?" @confirm="deleteRole(scope.row.id)">
              <template #reference>
  ...
  >
    <el-form ref="roleFormRef" :model="roleForm" label-width="80" label-position="left" :rules="rules">
...
import { reqRoleSelect, reqRoleAdd, reqRoleUpdate,reqRoleDelete} from '@/api/acl/role/index'
...
const addRole = async (formEl:any) => {
  ...
  await formEl.validate(async (valid:any, fields:any) => {
    if (valid) {
      ...
      if(option.value === 1) roleForm.value.createTime = GetDate('YYYY-MM-DD HH:mm:ss')
      let res: any = null
...
const selectRole = async (pageNum:number,pageSize:number,roleName:string) => { 
