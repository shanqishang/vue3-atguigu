<template>
  <div class="login">
    <div class="login-div">
      <h2>欢迎来到鼓励商城</h2>
      <el-form class="login-form" :model="form" label-width="auto" :rules="rules" ref="ruleFormRef">
        <el-form-item label="用户名：" prop="username">
          <el-input :prefix-icon="User" v-model="form.username"/>
        </el-form-item>
        <el-form-item label="密码：" prop="password">
          <el-input type='password' :prefix-icon="Lock" v-model="form.password" show-password/>
        </el-form-item>
        <el-form-item>
          <el-button :loading="loading" type="primary" class="login-button" size="default" @click="login">登录</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
