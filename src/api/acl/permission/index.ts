...
export const permission_add = (data: any) => request.post(API.PERMISSION_ADD, data)
export const permission_update = (data: any) => request.put(API.PERMISSION_UPDATE, data)
export const permission_delete = (id:number) => request.delete(API.PERMISSION_DELETE+`/${id}`)